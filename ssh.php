...
<?php
    ...
    echo '</div>'."\n";
    echo '</td>'."\n";
// hier muss die aktuelle IP Adresse des Raspberries eingetragen sein. localhost funktioniert nicht
// ausserdem muss zuerst einmal die Seite direkt per Browser aufgerufen werden, um die Meckereien wg. unsicherer Seite zu bestätigen
    echo '<iframe src="https://' . exec('hostname -I | awk \'{print $1}\'') . ':4200" width="800px" height="450px" style = "background-color:#f1f1f1;"></iframe>';
    echo "<tr> <td>&nbsp;</td></tr>";
?>
</table>
<?php
