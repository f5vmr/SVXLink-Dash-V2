...
foreach ($lines as $i => $line) {
    if (preg_match($pattern, $line, $m)) {
        ...
        if ($color !== '' && !in_array($color, $colorSet)) $colorSet[] = $color;
    }
}
...
<head>
    ...
    <style type="text/css">
        ...
        a { color: #607d8b; }
        .highlighter-rouge { background-color: #fff; border: 1px solid #ccc; border-radius: .2em; font-size: .8em; overflow-x: auto; padding: .2em .4em; }
        pre { margin: 0; padding: .6em; overflow-x: auto; }
        #player { position:relative; width:205px; overflow: hidden; direction: ltl; }
        textarea { background-color: #111; border: 1px solid #000; color: #fff; padding: 1px; font-family: courier new; font-size:10px; }
...
<center>
<h1 style="color:#00aee8;font: 18pt arial, sans-serif;font-weight:bold; text-shadow: 0.25px 0.25px gray;">Button Configurator</h1>
