...
<body style="background-color: #e1e1e1;font: 11pt arial, sans-serif;">
    ...
    <fieldset style="border:#3083b8 2px groove;box-shadow:5px 5px 20px #999; background-color:#f1f1f1; width:555px;margin-top:15px;margin-left:0px;margin-right:5px;font-size:13px;border-top-left-radius: 10px; border-top-right-radius: 10px;border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
        <div style="padding:0px;width:550px;background-image: linear-gradient(to bottom, #e9e9e9 50%, #bcbaba 100%);border-radius: 10px;-moz-border-radius:10px;-webkit-border-radius:10px;border: 1px solid LightGrey;margin-left:0px; margin-right:0px;margin-top:4px;margin-bottom:0px;line-height:1.6;white-space:normal;">
            <center>
            <h1 id="ConfEditor" style="color:#00aee8;font: 18pt arial, sans-serif;font-weight:bold; text-shadow: 0.25px 0.25px gray;">Конфигуратор информации о узле</h1>
            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
                <table>
                    <tr>
                        <th width="380px">Редактор информации о узле</th>
                    ...
                    <tr>
                        <td>
                            <table style="border-collapse: collapse; border: none;">
                                ...
                                <tr style="border: none;">
                                    <td style="border: none;">Местоположение узла:</td>
                        ...
                        <td>
                            <button name="btnSave" type="submit" class="red" style="height:100px; width:105px; font-size:12px;">Сохранить и перезагрузить</button>
                        </td>
                    </tr>
                    <tr>
                        <th width="380px">Информация о QTH</th>
                        <th width="100px">Действие</th>
                    </tr>
                    <tr>
                        <td>
                            <table style="border-collapse: collapse; border: none;">
                                ...
                                <tr style="border: none;">
                                    <td style="border: none;">Местоположение:</td>
                                ...
                                <tr style="border: none;">
                                    <td style="border: none;">Широта:</td>
                                ...
                                <tr style="border: none;">
                                    <td style="border: none;">Долгота:</td>
                                ...
                                <tr style="border: none;">
                                    <td style="border: none;">Локатор:</td>
                    ...
                    <tr>
                        <th width="380px">Информация о приемнике</th>
                        <th width="100px">Действие</th>
                    </tr>
                    <tr>
                        <td>
                            <table style="border-collapse: collapse; border: none;">
                                ...
                                <tr style="border: none;">
                                    <td style="border: none;">Частота:</td>
                    ...
                    <tr>
                        <th width="380px">Информация о передатчике</th>
                        <th width="100px">Действие</th>
                    </tr>
                    <tr>
                        <td>
