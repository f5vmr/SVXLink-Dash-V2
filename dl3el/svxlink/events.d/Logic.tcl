...
proc dtmf_cmd_received {cmd} {
  ...
  if {$cmd == "98"} {
#    exec bash /etc/svxlink/scripts/ipaddr.sh
    exec perl /etc/svxlink/scripts/get-ip.pl >/tmp/ipaddr1.tcl 
    puts "Play IP address: $cmd #";
   CW::play "IP "
    playSilence 100;
#    source "/tmp/ipaddr0.tcl";
#    playSilence 100;
#    puts "Play IP address0: $ipaddr0";
#    spellWord $ipaddr0;
#    playSilence 100;
    source "/tmp/ipaddr1.tcl";
    return 1
  }
  if {$cmd == "97"} {
