...
PCMPlayer.prototype.feed = function (t) {
    ...
    if (this.isTypedArray(t)) {
        ...
        i = new Float32Array(this.samples.length + t.length);
...
PCMPlayer.prototype.getFormatedValue = function (t) {
    var t = new this.typedArray(t.buffer),
...
PCMPlayer.prototype.flush = function () {
    if (this.samples.length) {
        var t, i, e, n, s = this.audioCtx.createBufferSource(),
            o = this.samples.length / this.option.channels,
            a = this.audioCtx.createBuffer(this.option.channels, o, this.option.sampleRate),
            r = 0;
        for (r = 0; r < this.option.channels; r++) {
            t = a.getChannelData(r);
            i = r;
            n = 50;
            for (e = 0; e < o; e++) {
                t[e] = this.samples[i];
                if (e < 50) t[e] = t[e] * e / 50;
                if (o - 51 <= e) t[e] = t[e] * n-- / 50;
...
SVXPlayer.prototype.play = function () {
    ...
    this.ws.addEventListener("message", function (t) {
        ...
        if (48000 == this.sampleRate) {
            r.player.feed(e);
        } else {
            var n = r.player.option.sampleRate / 48000,
