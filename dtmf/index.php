...
if (isset($_POST['button2'])) {
    shell_exec('echo "912350#" > /etc/svxlink/dtmf_svx');
}

if (isset($_POST['button3'])) {
    shell_exec('echo "9123561#" > /etc/svxlink/dtmf_svx');
}

if (isset($_POST['button4'])) {
    shell_exec('echo "910#" > /etc/svxlink/dtmf_svx');
}

if (isset($_POST['button5'])) {
    shell_exec('echo "919050#" > /etc/svxlink/dtmf_svx');
}

if (isset($_POST['button6'])) {
    shell_exec('echo "9143136#" > /etc/svxlink/dtmf_svx');
}

if (isset($_POST['button7'])) {
    shell_exec('echo "9149720#" > /etc/svxlink/dtmf_svx');
}
...
if (isset($_POST['button9'])) {
    shell_exec('echo "*#" > /etc/svxlink/dtmf_svx');
}

if (isset($_POST['button10'])) {
    shell_exec('echo "1#" > /etc/svxlink/dtmf_svx');
}

if (isset($_POST['button11'])) {
    shell_exec('echo "2# 453582#" > /etc/svxlink/dtmf_svx');
}

if (isset($_POST['button12'])) {
    shell_exec('echo "2# 871657## " > /etc/svxlink/dtmf_svx');
}
...
{
    shell_exec('echo "0" > /etc/svxlink/dtmf_svx');
...
{
    shell_exec('echo "A" > /etc/svxlink/dtmf_svx');
 //   echo '<pre><h1><center><p style="color: #454545; ">Send DTMF: #</center></h1></p></pre$    }
}
if (isset($_POST['buttonBB']))
{
    shell_exec('echo "B" > /etc/svxlink/dtmf_svx');
 //   echo '<pre><h1><center><p style="color: #454545; ">Send DTMF: #</center></h1></p></pre$    }
}

if (isset($_POST['buttonCC']))
{
    shell_exec('echo "C" > /etc/svxlink/dtmf_svx');
 //   echo '<pre><h1><center><p style="color: #454545; ">Send DTMF: #</center></h1></p></pre$    }
}

if (isset($_POST['buttonDD']))
{
    shell_exec('echo "D" > /etc/svxlink/dtmf_svx');
 //   echo '<pre><h1><center><p style="color: #454545; ">Send DTMF: #</center></h1></p></pre$    }
}
