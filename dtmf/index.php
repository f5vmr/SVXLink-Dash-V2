...
if (isset($_POST['button1'])) {
    shell_exec('echo "91235#" > /dev/shm/simplex_dtmf_ctrl');
}

if (isset($_POST['button2'])) {
    shell_exec('echo "912350#" > /dev/shm/simplex_dtmf_ctrl');
}

if (isset($_POST['button3'])) {
    shell_exec('echo "9123561#" > /dev/shm/simplex_dtmf_ctrl');
}

if (isset($_POST['button4'])) {
    shell_exec('echo "910#" > /dev/shm/simplex_dtmf_ctrl');
}

if (isset($_POST['button5'])) {
    shell_exec('echo "919050#" > /dev/shm/simplex_dtmf_ctrl');
}

if (isset($_POST['button6'])) {
    shell_exec('echo "9143136#" > /dev/shm/simplex_dtmf_ctrl');
}

if (isset($_POST['button7'])) {
    shell_exec('echo "9149720#" > /dev/shm/simplex_dtmf_ctrl');
}
...
if (isset($_POST['button9'])) {
    shell_exec('echo "*#" > /dev/shm/simplex_dtmf_ctrl');
}

if (isset($_POST['button10'])) {
    shell_exec('echo "1#" > /dev/shm/simplex_dtmf_ctrl');
}

if (isset($_POST['button11'])) {
    shell_exec('echo "2# 453582#" > /dev/shm/simplex_dtmf_ctrl');
}

if (isset($_POST['button12'])) {
    shell_exec('echo "2# 871657## " > /dev/shm/simplex_dtmf_ctrl');
}
...
{
    shell_exec('echo "0" > /dev/shm/simplex_dtmf_ctrl');
...
{
    shell_exec('echo "A" > /dev/shm/simplex_dtmf_ctrl');
 //   echo '<pre><h1><center><p style="color: #454545; ">Send DTMF: #</center></h1></p></pre$    }
}
if (isset($_POST['buttonBB']))
{
    shell_exec('echo "B" > /dev/shm/simplex_dtmf_ctrl');
 //   echo '<pre><h1><center><p style="color: #454545; ">Send DTMF: #</center></h1></p></pre$    }
}

if (isset($_POST['buttonCC']))
{
    shell_exec('echo "C" > /dev/shm/simplex_dtmf_ctrl');
 //   echo '<pre><h1><center><p style="color: #454545; ">Send DTMF: #</center></h1></p></pre$    }
}

if (isset($_POST['buttonDD']))
{
    shell_exec('echo "D" > /dev/shm/simplex_dtmf_ctrl');
 //   echo '<pre><h1><center><p style="color: #454545; ">Send DTMF: #</center></h1></p></pre$    }
}
