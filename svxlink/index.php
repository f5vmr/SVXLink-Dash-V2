...
<?php
	...
	$svxconfig['GLOBAL']['LOGICS'] = isset($_POST['inGlobalLogics']);
        $svxconfig['GLOBAL']['RF_MODULE'] = isset($_POST['inGlobalRf']);
        $svxconfig['GLOBAL']['CFG_DIR'] = isset($_POST['inGlobalCfgDir']);
        $svxconfig['GLOBAL']['TIME_FORMAT'] = isset($_POST['inTimeFormat']);
        $svxconfig['GLOBAL']['CARD_SAMPLE_RATE'] = isset($_POST['inCardSampleRate']);
        $svxconfig['GLOBAL']['CARD_CHANNELS'] = isset($_POST['inCardChannels']);
        $svxconfig['GLOBAL']['LOCATION_INFO'] = isset($_POST['inLocationInfo']);
        $svxconfig['GLOBAL']['LINKS'] = isset($_POST['inLinks']);
        $svxconfig['GLOBAL']['CW_AMP'] = isset($_POST['inCwAmp']);
        $svxconfig['GLOBAL']['CW_PITCH'] = isset($_POST['inCwPitch']);
        $svxconfig['GLOBAL']['CW_CPM'] = isset($_POST['inCwCpm']);
        if ($key == "ReflectorLogic") {
	$svxconfig['ReflectorLogic']['HOSTS'] = isset($_POST['inReflectorServer']);
        $svxconfig['ReflectorLogic']['HOST_PORT'] = isset($_POST['inReflectorPort']);
        $svxconfig['ReflectorLogic']['FMNET'] = isset($_POST['inFmnetwork']);
	$svxconfig['ReflectorLogic']['API'] = isset($_POST['inrefApi']);
        $svxconfig['ReflectorLogic']['DEFAULT_TG'] = isset($_POST['inDefaultTg']);
        $svxconfig['ReflectorLogic']['TG_SELECT_TIMEOUT'] = isset($_POST['inTgSelectTimeout']);
        $svxconfig['ReflectorLogic']['MONITOR_TGS'] = isset($_POST['inMonitorTgs']);
        $svxconfig['ReflectorLogic']['AUTH_KEY'] = isset($_POST['password']);
        $svxconfig['ReflectorLogic']['CALLSIGN'] = isset($_POST['inRefCallsign']);
        $svxconfig['ReflectorLogic']['DEFAULT_LANG'] = isset($_POST['inReflectorDefaultLang']);
        $svxconfig['ReflectorLogic']['NODE_INFO_FILE'] = isset($_POST['inNodeInfoFile']);
        }

	//$svxconfig['ReflectorLogic']['TG_URI'] = $_POST['inReflectorTgUri'];

        if ($system_type == "IS_SIMPLEX"){
	$svxconfig['SimplexLogic']['DEFAULT_LANG'] = isset($_POST['inSimplexDefaultLang']);
        $svxconfig['SimplexLogic']['CALLSIGN'] = isset($_POST['inSimplexCallsign']);
        $svxconfig['SimplexLogic']['MODULES'] = isset($_POST['inSimplexModules']);
        $svxconfig['SimplexLogic']['SHORT_IDENT_INTERVAL'] = isset($_POST['inSimShortInterval']);
        $svxconfig['SimplexLogic']['LONG_IDENT_INTERVAL'] = isset($_POST['inSimLongInterval']);
        $svxconfig['SimplexLogic']['RGR_SOUND_DELAY'] = isset($_POST['inRgrDelay']);
        $svxconfig['SimplexLogic']['RGR_SOUND_ALWAYS'] = isset($_POST['inRgr']);
        $svxconfig['SimplexLogic']['FX_GAIN_NORMAL'] = isset($_POST['inFxGainNormal']);
        $svxconfig['SimplexLogic']['FX_GAIN_LOW'] = isset($_POST['inFxGainLow']);
        $svxconfig['SimplexLogic']['ONLINE_CMD'] = isset($_POST['inOnLineCmd']);
        $svxconfig['SimplexLogic']['ONLINE'] = isset($_POST['inOnLine']);    
        }
        if ($system_type == "IS_DUPLEX") {
        $svxconfig['RepeaterLogic']['DEFAULT_LANG'] = isset($_POST['inRepeaterDefaultLang']);
        $svxconfig['RepeaterLogic']['CALLSIGN'] = isset($_POST['inRepeaterCallsign']);
        $svxconfig['RepeaterLogic']['MODULES'] = isset($_POST['inRepeaterModules']);
        $svxconfig['RepeaterLogic']['SHORT_IDENT_INTERVAL'] = isset($_POST['inRepShortInterval']);
        $svxconfig['RepeaterLogic']['LONG_IDENT_INTERVAL'] = isset($_POST['inRepLongInterval']);
        $svxconfig['RepeaterLogic']['IDLE_TIMEOUT'] = isset($_POST['inIdleTime']);
        $svxconfig['RepeaterLogic']['OPEN_ON_1750'] = isset($_POST['in1750']);
        $svxconfig['RepeaterLogic']['OPEN_ON_CTCSS'] = isset($_POST['inCTCSS']);
        $svxconfig['RepeaterLogic']['OPEN_SQL_FLANK'] = isset($_POST['inSqlFlank']);
        $svxconfig['RepeaterLogic']['RGR_SOUND_DELAY'] = isset($_POST['inRgrDelay']);
        $svxconfig['RepeaterLogic']['IDLE_SOUND_INTERVAL'] = isset($_POST['inIdleIntervalTime']);
        $svxconfig['RepeaterLogic']['ONLINE_CMD'] = isset($_POST['inOnLineCommand']);
        $svxconfig['RepeaterLogic']['ONLINE'] = isset($_POST['inOnline']);
        $svxconfig['RepeaterLogic']['FX_GAIN_NORMAL'] = isset($_POST['inFxGainNormal']);
        $svxconfig['RepeaterLogic']['FX_GAIN_LOW'] = isset($_POST['inFxGainLow']);
        }
        if ($key == "ReflectorLogic") {
        $svxconfig['LinkToReflector']['CONNECT_LOGICS'] = isset($_POST['inConnLogic'];
        }
        $svxconfig['Macros']['0'] = isset($_POST['inMD0']);
        $svxconfig['Macros']['1'] = isset($_POST['inMD1']);
	$svxconfig['Macros']['2'] = isset($_POST['inMD2']);
	$svxconfig['Macros']['3'] = isset($_POST['inMD3']);
	$svxconfig['Macros']['4'] = isset($_POST['inMD4']);
	$svxconfig['Macros']['5'] = isset($_POST['inMD5']);
	$svxconfig['Macros']['6'] = isset($_POST['inMD6']);
	$svxconfig['Macros']['7'] = isset($_POST['inMD7']);
	$svxconfig['Macros']['8'] = isset($_POST['inMD8']);
	$svxconfig['Macros']['9'] = isset($_POST['inMD9']);
        $svxconfig['Rx1']['TYPE'] = isset($_POST['inRxType']);
        $svxconfig['Rx1']['AUDIO_DEV'] = isset($_POST['inRxAudioDev']);
        $svxconfig['Rx1']['AUDIO_CHANNEL'] = isset($_POST['inRxAudioChan']);
        $svxconfig['Rx1']['SQL_DET'] = isset($_POST['inSql_Det']);
        $svxconfig['Rx1']['SQL_START_DELAY'] = isset($_POST['inSqlStartDelay']);
        $svxconfig['Rx1']['SQL_DELAY'] = isset($_POST['inSqlDelay']);
        $svxconfig['Rx1']['SQL_HANG_TIME'] = isset($_POST['inSqlHangTime']);
        $svxconfig['Rx1']['SQL_GPIOD_CHIP'] = isset($_POST['inSqlChip']);
        $svxconfig['Rx1']['SQL_GPIOD_LINE'] = isset($_POST['inSqlLine']);
        $svxconfig['Rx1']['HID_DEVICE'] = isset($_POST['inRxHIDDevice']);
        $svxconfig['Rx1']['HID_SQL_PIN'] = isset($_POST['inRxHIDPin']);
        $svxconfig['Rx1']['SQL_TAIL_ELIM'] = isset($_POST['inSqlTail']);
        $svxconfig['Rx1']['1750_MUTING'] = isset($_POST['in1750Mute']);
        $svxconfig['Rx1']['DTMF_MUTING'] = isset($_POST['inDTMFMute']);
        $svxconfig['Rx1']['FQ'] = isset($_POST['inRxFreq']);
        $svxconfig['Rx1']['MODULATION'] = isset($POST['inMod']);
	$svxconfig['Rx1']['PEAK_METER'] = isset($_POST['inRx1PeakMeter']);
        $svxconfig['Tx1']['TYPE'] = isset($_POST['inTxType']);
        $svxconfig['Tx1']['AUDIO_DEV'] = isset($_POST['inTxAudioDev']);
        $svxconfig['Tx1']['AUDIO_CHANNEL'] = isset($_POST['inTxAudioChannel']);
        $svxconfig['Tx1']['PTT_TYPE'] = isset($_POST['inPttType']);
        $svxconfig['Tx1']['PTT_PORT'] = isset($_POST['inPttPort']);
        $svxconfig['Tx1']['HID_DEVICE'] = isset($_POST['inTxHidDevice']);
        $svxconfig['Tx1']['PTT_PIN'] = isset($_POST['inPttPin']);
        $svxconfig['Tx1']['HID_PTT_PIN'] = isset($_POST['inHidPttPin']);
        $svxconfig['Tx1']['PTT_HANGTIME'] = isset($_POST['inPttHangtime']);
        $svxconfig['Tx1']['PTT_GPIOD_CHIP'] = isset($_POST['inPttGPIOChip']);
        $svxconfig['Tx1']['PTT_GPIOD_LINE'] = isset($_POST['inPttGPIOLine']);
        $svxconfig['Tx1']['TIMEOUT'] = isset($_POST['inTxTimeout']);
        $svxconfig['MultiTx']['TRANSMITTERS'] = isset($_POST['inMultiTx']);
        $svxconfig['TxStream']['AUDIO_DEV'] = isset($_POST['inTxStreamAudioDev']);
        $svxconfig['NetRx']['HOST'] = isset($_POST['inNetRxHost']);
        $svxconfig['NetRx']['PORT'] = isset($_POST['inNetRxPort']);
        $svxconfig['NetRx']['AUTH_KEY'] = isset($_POST['inNetRxAuthKey']);
        $svxconfig['NetTx']['HOST'] = isset($_POST['inNetTxHost']);
        $svxconfig['NetTx']['PORT'] = isset($_POST['inNetTxPort']);
        $svxconfig['NetTx']['AUTH_KEY'] = isset($_POST['inNetTxAuthKey']);
        $svxconfig['LocationInfo']['APRS_SERVER_LIST'] = isset($_POST['inAprsServerList']);
        $svxconfig['LocationInfo']['STATUS_SERVER_LIST'] = isset($_POST['inStatusServerList']);
        $svxconfig['LocationInfo']['LON_POSITION'] = isset($_POST['inLon']);
        $svxconfig['LocationInfo']['LAT_POSITION'] = isset($_POST['inLat']);
        $svxconfig['LocationInfo']['CALLSIGN'] = isset($_POST['inLocInfoCallsign']);
        $svxconfig['LocationInfo']['FREQUENCY'] = isset($_POST['inLocInfFreq']);
        $svxconfig['LocationInfo']['TXPOWER'] = isset($_POST['inTxPower']);
        $svxconfig['LocationInfo']['ANTENNA_GAIN'] = isset($_POST['inAntennaGain']);
        $svxconfig['LocationInfo']['ANTENNA_HEIGHT'] = isset($_POST['inAntennaHeight']);
        $svxconfig['LocationInfo']['ANTENNA_DIR'] = isset($_POST['inAntennaDir']);
        $svxconfig['LocationInfo']['PATH'] = isset($_POST['inPath']);
        $svxconfig['LocationInfo']['BEACON_INTERVAL'] = isset($_POST['inBeaconInterval']);
        $svxconfig['LocationInfo']['COMMENT'] = isset($_POST['inComment']);      
