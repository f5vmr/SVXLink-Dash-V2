...
include 'include/config.inc.php';  // Adjust filename as per your actual configuration
...
// Parse configuration file and insert into SQLite database
...
<head>
    ...
    <link href="/css/css.php" type="text/css" rel="stylesheet" />  <!-- Adjust CSS path as necessary -->
    <style>
        body {
...
<body>
    <center>
        <fieldset>
            <div>
                <h1 id="svxlink">SVXLink Configurator</h1>
