...
<center>
    <fieldset style="border:#3083b8 2px groove;
                 ...
                 width:565px;              /* +5px */
                 margin-top:5px;           /* push up a bit */
                 margin-left:-5px;         /* push left 5px */
                 margin-right:5px;         /* right stays */
                 font-size:13px;
                 border-radius: 10px;">
    <div style="padding:0px;
                ...
                margin-left:-5px;       /* push left */
                margin-right:-5px;      /* push right */
                margin-top:-1px;        /* push upward */
                margin-bottom:-1px;     /* push downward */
                line-height:1.4;
                white-space:normal;">
        <h1 id="web-audio-peak-meters" style="color:#00aee8;
