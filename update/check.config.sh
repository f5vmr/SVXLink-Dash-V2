...
#name=$(curl -sl https://api.github.com/repos/releases/latest | jq -r .name) 
#published=$(curl -sl https://api.github.com/repos/releases/latest | jq -r .published_at)
#body=$(curl -sl https://api.github.com/repos/releases/latest | jq -r .body) 
