...
#tagname=$(curl -sl https://api.github.com/repos/sounds/releases/latest | jq -r .tag_name)
...
#zipball=$(curl -sl https://api.github.com/repos/sounds/releases/latest | jq -r .zipball_url)
