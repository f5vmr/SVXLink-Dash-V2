...
if ($modecho=="True") {
  ...
  $echotxing = (is_array($users) && count($users) > 0) ? $users[count($users)-1] : "-";

  echo "<table style=\"margin-top:4px;margin-bottom:13px;\">";
  echo "<tr><th colspan=\"2\">EchoLink Connected Nodes</th></tr>";

  if (count($users) != 0) {
    echo "<tr><td colspan=\"2\" style=\"background:#f6f6bd;\"><div style=\"margin-top:4px;margin-bottom:4px;white-space:normal;color:#0065ff;font-weight:bold;\">";
